...
public class BankingMain {
	...
	public static void main(String[] args) {
		...
		PersonInformation person1 = new PersonInformation("Anusha", 12345, 10000);
		PersonInformation person2 = new PersonInformation("Vysakh", 67890, 12000);
		PersonInformation person3 = new PersonInformation("Ajith", 24680, 14000);
		...
		QueueImplementation queue = new QueueImplementation(personNumber.length);
